...
export const AdminDashboardPage = () => {
  ...
  return (
    <div className={styles.page}>
      <div>
        <h2 className={styles.pageTitle}>Табло</h2>
        <p className={styles.pageSub}>Добре дошли в административния панел на Princeps Дневник.</p>
      </div>

      {isLoading ? (
        <div className={styles.loadingWrapper}>
          <CircularProgress sx={{ color: '#C9A24E' }} />
        </div>
      ) : data ? (
        <>
